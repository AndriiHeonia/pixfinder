...
export interface FindAllFeaturesOptions {
...
export function find (options: Partial<FindFeatureOptions>): Point[];

// Search all objects on the image.
export function findAll (options: Partial<FindAllFeaturesOptions>): Point[][];
